      ...
      <div className="w-[600px] flex flex-col items-center">
        ...
        <div className="flex w-full my-2">
          <Input
            ...
            className="w-full"
          />
          <Button onClick={HandlePublish} className="ml-2 hover:border-black hover:bg-black hover:text-white text-black border-2 border-black bg-white">
            Publish
          </Button>
        </div>
        <div className="flex w-full mb-2">
          <Input onChange={HandleImageUpload} id="picture" className="cursor-pointer" type="file" />
          <Button onClick={()=>{
                setuploadImage(true);
          }
        ...
        <div className="mb-2">
            {loadingcomplete && <img src={postInput.imagelink} alt="image" className="border-black border-4  h-[300px]" />}
        </div>
        <ReactQuill
...
function Spinner(){
    return (
        <div className="h-screen w-[120px] flex justify-center items-center">
